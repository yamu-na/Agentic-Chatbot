...
class AINewsNode:
    def __init__(self,llm):
        """ Initilaize the AINewsNode with API keys for Tavily and OpenAI """

        self.tavily=TavilyClient()
        self.llm=llm
        ##This is uised to capture various steps in this file so that later can be use for steps shown 
        self.state={}
